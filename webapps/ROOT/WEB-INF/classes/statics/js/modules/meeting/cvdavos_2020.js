var vm = new Vue({
    ...
    created () {
        ...
        if (window.location.href.indexOf('chinaventure.com.cn') !== -1 || window.location.href.indexOf('cvmedia.com.cn') !== -1 || window.location.href.indexOf('117.78.28.103') !== -1) {
            console.log('正式环境')
            this.meetingBaseInfoId = '54'//基础信息ID,写死
            this.meetingAgendaId = '42'//日程ID,写死
            this.meetingGuestId = '31'//嘉宾ID,写死
        } else {
            console.log('测试环境')
            this.meetingBaseInfoId = '39'//基础信息ID,写死
            this.meetingAgendaId = '48'//日程ID,写死
            this.meetingGuestId = '40'//嘉宾ID,写死
        }
    },
    mounted () {
    },
