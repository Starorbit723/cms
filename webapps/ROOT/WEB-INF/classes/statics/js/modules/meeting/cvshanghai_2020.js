var vm = new Vue({
    ...
    created () {
        ...
        if (window.location.href.indexOf('chinaventure.com.cn') !== -1 || window.location.href.indexOf('cvmedia.com.cn') !== -1 || window.location.href.indexOf('117.78.28.103') !== -1) {
            ...
            this.meetingForm.meetingAgendaId = '52'//日程ID,写死
            this.meetingForm.meetingGuestId = '41'//嘉宾ID,写死
            this.meetingForm.meetingCooperationId = '40'//合作机构ID,写死
            this.meetingForm.meetingRankId = '20'//榜单ID,写死
        }
    },
    mounted () {
    },
