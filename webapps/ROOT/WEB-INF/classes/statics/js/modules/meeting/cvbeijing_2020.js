var vm = new Vue({
    ...
    created () {
        ...
        if (window.location.href.indexOf('chinaventure.com.cn') !== -1 || window.location.href.indexOf('cvmedia.com.cn') !== -1 || window.location.href.indexOf('117.78.28.103') !== -1) {
            console.log('正式环境')
            this.meetingBaseInfoId = '65'
            this.meetingAgendaId = '51'
            this.meetingCooperationId = '31'
            this.meetingGuestId = '35'
            this.meetingRankId = '19'
        } else {
            console.log('测试环境')
            this.meetingBaseInfoId = '49'
            this.meetingAgendaId = '56'
            this.meetingCooperationId = '43'
            this.meetingGuestId = '44'  
            this.meetingRankId = '21'
        }
    },
    mounted () {
    },
